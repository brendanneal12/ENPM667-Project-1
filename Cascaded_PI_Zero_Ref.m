...
%% ENPM667 Project 1
%% Cascaded PI Zero Reference Response
...
Va = 7; %m/s
out1 = sim('Simulink_Models/Cascaded_PI_Zero_Ref_Test.slx',50);
Va = 10; %m/s
out2 = sim('Simulink_Models/Cascaded_PI_Zero_Ref_Test.slx',50);
Va = 15; %m/s
out3 = sim('Simulink_Models/Cascaded_PI_Zero_Ref_Test.slx',50);
...
title('Cascaded PI Zero Ref Response Test - Phi vs. Time')
...
title('Cascaded PI Zero Ref Response Test - Control Signal vs. Time')